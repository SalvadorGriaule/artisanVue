...
<template>
    <AuthBase title="Create an account" description="Enter your details below to create your account">
        ...
        <Head title="Register" />
        <nav><button
                class="rounded-t-xl border border-slate-300 bg-gradient-to-b from-slate-300 to-white p-2 w-1/2">Vendeur</button><button
                class="rounded-t-xl border border-slate-300 bg-gradient-to-b from-slate-300 to-white p-2 w-1/2">Acheteur</button>
        </nav>
        <div>
