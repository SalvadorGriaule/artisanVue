            ...
            <Form v-bind="update.put(product.id)"
                ...
                <div class="grid gap-6">
                    <div class="grid gap-2">
                        ...
                        <Input id="name" type="text" required autofocus :tabindex="1" autocomplete="name" name="name" :default-value="product.name"
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="price" type="number" required :tabindex="4" name="price" :default-value="product.price"
                            placeholder="0" />
